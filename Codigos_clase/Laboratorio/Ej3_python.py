...
# Solicitar radio y número de lados al usuario
R = simpledialog.askinteger("Input", "Escribe el radio en mm:", minvalue=1)
n_sides = simpledialog.askinteger("Input", "Escribe el número de lados del polígono:", minvalue=3)
...
print("Tracing a polygon around the target:")
...
# Dibujar el polígono alrededor del punto de referencia
for i in range(n_sides + 1):
    ang = i * 2 * pi / n_sides  # Ángulo en radianes
...
tk.messagebox.showinfo("Completed", "El Polígono ha sido dibujado correctamente!")
